        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <form method="post" action="{{ asset(route('brand.update', $brand->id)) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="tab-content mt-3" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <img src="{{ asset($brand->photo) }}" class="img-fluid table-bordered border-dark rounded" width="300" height="200">
