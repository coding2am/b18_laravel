...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <div class="app-sidebar__user"><img width="50" height="50" class="app-sidebar__user-avatar" src="{{asset('images/user.png')}}" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">thruasittnaing</p>
      ...
      <li><a class="app-menu__item" href="{{url('/')}}"><i class="app-menu__icon fa fa-globe"></i><span class="app-menu__label">Public Home Page</span></a></li>
        <li><a href="{{ asset(route('brand.index'))}}" class="app-menu__item 
          ...
          @endphp
          "><i class="app-menu__icon fa fa-cubes"></i><span class="app-menu__label">Brand</span></a></li>
        <li><a href="{{ asset(route('category.index'))}}" class="app-menu__item
           {{-- category --}}
          @php
          $word = "App\Http\Controllers\CategoryController";
          ...
          @endphp
          "><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Category</span></a></li>
        <li><a href="{{ asset(route('subcategory.index'))}}" class="app-menu__item
           {{-- subcategory --}}
          @php
          $word = "App\Http\Controllers\SubCategoryController";
          $key = Route::currentRouteAction();
          if(strpos($key, $word) !== false)
          {
          echo "active";
          ...
          @endphp
          "><i class="app-menu__icon fa fa-th-large"></i><span class="app-menu__label">SubCategory</span></a></li>
        <li><a href="{{ asset(route('item.index'))}}" class="app-menu__item 
           {{-- item --}}
          @php
          $word = "item";
          $key = Route::currentRouteName();
